...
#ifndef _MICROCHIP_PIC32CXBZ2_OSCCTRL_COMPONENT_FIXUP_H_
#define _MICROCHIP_PIC32CXBZ2_OSCCTRL_COMPONENT_FIXUP_H_
...
typedef struct {
  ...
  __IO OSCCTRL_DFLLSYNC_Type     DFLLSYNC;    /**< \brief Offset: 0x2C (R/W  8) DFLL48M Synchronization */
       ...
       // yfy OscctrlDpll               Dpll[OSCCTRL_DPLL_NUMBER];     /**< \brief Offset: 0x30 OscctrlDpll groups [DPLLS_NUM] */
} Oscctrl;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */

#endif /* _MICROCHIP_PIC32CXBZ2_OSCCTRL_COMPONENT_FIXUP_H_ */
