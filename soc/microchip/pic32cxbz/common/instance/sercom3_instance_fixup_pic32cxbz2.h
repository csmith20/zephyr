...
#ifndef _MICROCHIP_PIC32CXBZ2_SERCOM3_INSTANCE_FIXUP_H_
#define _MICROCHIP_PIC32CXBZ2_SERCOM3_INSTANCE_FIXUP_H_
...
#define REG_SERCOM3_I2CM_CTRLC     (0x42001008) /**< \brief (SERCOM3) I2CM Control C */
...
#define REG_SERCOM3_I2CS_CTRLC     (0x42001008) /**< \brief (SERCOM3) I2CS Control C */
...
#define REG_SERCOM3_I2CS_LENGTH    (0x42001022) /**< \brief (SERCOM3) I2CS Length */
...
#define REG_SERCOM3_SPI_CTRLC      (0x42001008) /**< \brief (SERCOM3) SPI Control C */
...
#define REG_SERCOM3_SPI_LENGTH     (0x42001022) /**< \brief (SERCOM3) SPI Length */
...
#define REG_SERCOM3_USART_LENGTH   (0x42001022) /**< \brief (SERCOM3) USART Length */
...
#define REG_SERCOM3_I2CM_CTRLC     (*(RwReg  *)0x42001008UL) /**< \brief (SERCOM3) I2CM Control C */
...
#define REG_SERCOM3_I2CM_DATA      (*(RwReg  *)0x42001028UL) /**< \brief (SERCOM3) I2CM Data */
...
#define REG_SERCOM3_I2CS_CTRLC     (*(RwReg  *)0x42001008UL) /**< \brief (SERCOM3) I2CS Control C */
...
#define REG_SERCOM3_I2CS_LENGTH    (*(RwReg16*)0x42001022UL) /**< \brief (SERCOM3) I2CS Length */
#define REG_SERCOM3_I2CS_ADDR      (*(RwReg  *)0x42001024UL) /**< \brief (SERCOM3) I2CS Address */
#define REG_SERCOM3_I2CS_DATA      (*(RwReg  *)0x42001028UL) /**< \brief (SERCOM3) I2CS Data */
...
#define REG_SERCOM3_SPI_CTRLC      (*(RwReg  *)0x42001008UL) /**< \brief (SERCOM3) SPI Control C */
...
#define REG_SERCOM3_SPI_LENGTH     (*(RwReg16*)0x42001022UL) /**< \brief (SERCOM3) SPI Length */
...
#define REG_SERCOM3_USART_LENGTH   (*(RwReg16*)0x42001022UL) /**< \brief (SERCOM3) USART Length */
#define REG_SERCOM3_USART_DATA     (*(RwReg  *)0x42001028UL) /**< \brief (SERCOM3) USART Data */
#define REG_SERCOM3_USART_DBGCTRL  (*(RwReg8 *)0x42001030UL) /**< \brief (SERCOM3) USART Debug Control */
#endif /* (defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */

#endif /* _MICROCHIP_PIC32CXBZ2_SERCOM3_INSTANCE_FIXUP_H_ */
