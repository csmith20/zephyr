...
#if defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)
#define AC                            (0x42001c00) /**< \brief (AC) APB Base Address */
#define ADC0                          (0x44001400) /**< \brief (ADC0) APB Base Address */
...
#define DMAC                          (0x41004000) /**< \brief (DMAC) APB Base Address */
#define DSU                           (0x41000000) /**< \brief (DSU) APB Base Address */
#define EIC                           (0x40000800) /**< \brief (EIC) APB Base Address */
#define EVSYS                         (0x41006000) /**< \brief (EVSYS) APB Base Address */
...
#define SERCOM0                       (0x40000c00) /**< \brief (SERCOM0) APB Base Address */
#define SERCOM1                       (0x40001000) /**< \brief (SERCOM1) APB Base Address */
...
#define AC                ((Ac       *)0x42001c00UL) /**< \brief (AC) APB Base Address */
...
#define DMAC              ((Dmac     *)0x41004000UL) /**< \brief (DMAC) APB Base Address */
#define DMAC_INST_NUM     1                          /**< \brief (DMAC) Number of instances */
#define DMAC_INSTS        { DMAC }                   /**< \brief (DMAC) Instances List */

#define DSU               ((Dsu      *)0x41000000UL) /**< \brief (DSU) APB Base Address */
#define DSU_INST_NUM      1                          /**< \brief (DSU) Number of instances */
#define DSU_INSTS         { DSU }                    /**< \brief (DSU) Instances List */

#define EIC               ((Eic      *)0x40000800UL) /**< \brief (EIC) APB Base Address */
#define EIC_INST_NUM      1                          /**< \brief (EIC) Number of instances */
#define EIC_INSTS         { EIC }                    /**< \brief (EIC) Instances List */

#define EVSYS             ((Evsys    *)0x41006000UL) /**< \brief (EVSYS) APB Base Address */
...
#define SERCOM0           ((Sercom   *)0x40000c00UL) /**< \brief (SERCOM0) APB Base Address */
#define SERCOM1           ((Sercom   *)0x40001000UL) /**< \brief (SERCOM1) APB Base Address */
...
#if    defined(__PIC32CX1012BZ25048__)
...
#include "sercom_fixup_pic32cxbz2.h"
#include "tc_fixup_pic32cxbz2.h"
#include "gmac_fixup_pic32cxbz2.h"
//#include "adc_fixup_pic32cxbz2.h"

/* #include "../common/soc_port.h" */
#include "../common/microchip_pic32cxbz2_dt.h"

#include "../common/component/ac_component_fixup_pic32cxbz2.h"
#include "../common/component/adc_component_fixup_pic32cxbz2.h"
#include "../common/component/aes_component_fixup_pic32cxbz2.h"
#include "../common/component/can_component_fixup_pic32cxbz2.h"
#include "../common/component/ccl_component_fixup_pic32cxbz2.h"
#include "../common/component/cmcc_component_fixup_pic32cxbz2.h"
#include "../common/component/dac_component_fixup_pic32cxbz2.h"
#include "../common/component/dmac_component_fixup_pic32cxbz2.h"
#include "../common/component/dsu_component_fixup_pic32cxbz2.h"
#include "../common/component/eic_component_fixup_pic32cxbz2.h"
#include "../common/component/evsys_component_fixup_pic32cxbz2.h"
#include "../common/component/freqm_component_fixup_pic32cxbz2.h"
#include "../common/component/gclk_component_fixup_pic32cxbz2.h"
#include "../common/component/gmac_component_fixup_pic32cxbz2.h"
#include "../common/component/hmatrixb_component_fixup_pic32cxbz2.h"
#include "../common/component/i2s_component_fixup_pic32cxbz2.h"
#include "../common/component/icm_component_fixup_pic32cxbz2.h"
#include "../common/component/mclk_component_fixup_pic32cxbz2.h"
#include "../common/component/nvmctrl_component_fixup_pic32cxbz2.h"
#include "../common/component/osc32kctrl_component_fixup_pic32cxbz2.h"
#include "../common/component/oscctrl_component_fixup_pic32cxbz2.h"
#include "../common/component/pac_component_fixup_pic32cxbz2.h"
#include "../common/component/pcc_component_fixup_pic32cxbz2.h"
#include "../common/component/pdec_component_fixup_pic32cxbz2.h"
#include "../common/component/port_component_fixup_pic32cxbz2.h"
#include "../common/component/qspi_component_fixup_pic32cxbz2.h"
#include "../common/component/ramecc_component_fixup_pic32cxbz2.h"
#include "../common/component/rstc_component_fixup_pic32cxbz2.h"
#include "../common/component/rtc_component_fixup_pic32cxbz2.h"
#include "../common/component/sdhc_component_fixup_pic32cxbz2.h"
#include "../common/component/sercom_component_fixup_pic32cxbz2.h"
#include "../common/component/supc_component_fixup_pic32cxbz2.h"
#include "../common/component/tc_component_fixup_pic32cxbz2.h"
#include "../common/component/tcc_component_fixup_pic32cxbz2.h"
#include "../common/component/trng_component_fixup_pic32cxbz2.h"
#include "../common/component/usb_component_fixup_pic32cxbz2.h"
#include "../common/component/wdt_component_fixup_pic32cxbz2.h"

#include "../common/instance/ac_instance_fixup_pic32cxbz2.h"
#include "../common/instance/adc0_instance_fixup_pic32cxbz2.h"
#include "../common/instance/adc1_instance_fixup_pic32cxbz2.h"
#include "../common/instance/aes_instance_fixup_pic32cxbz2.h"
#include "../common/instance/can0_instance_fixup_pic32cxbz2.h"
#include "../common/instance/can1_instance_fixup_pic32cxbz2.h"
#include "../common/instance/ccl_instance_fixup_pic32cxbz2.h"
#include "../common/instance/cmcc_instance_fixup_pic32cxbz2.h"
#include "../common/instance/dac_instance_fixup_pic32cxbz2.h"
#include "../common/instance/dmac_instance_fixup_pic32cxbz2.h"
#include "../common/instance/dsu_instance_fixup_pic32cxbz2.h"
#include "../common/instance/eic_instance_fixup_pic32cxbz2.h"
#include "../common/instance/evsys_instance_fixup_pic32cxbz2.h"
#include "../common/instance/freqm_instance_fixup_pic32cxbz2.h"
#include "../common/instance/gclk_instance_fixup_pic32cxbz2.h"
#include "../common/instance/gmac_instance_fixup_pic32cxbz2.h"
#include "../common/instance/hmatrix_instance_fixup_pic32cxbz2.h"
#include "../common/instance/i2s_instance_fixup_pic32cxbz2.h"
#include "../common/instance/icm_instance_fixup_pic32cxbz2.h"
#include "../common/instance/mclk_instance_fixup_pic32cxbz2.h"
#include "../common/instance/nvmctrl_instance_fixup_pic32cxbz2.h"
#include "../common/instance/osc32kctrl_instance_fixup_pic32cxbz2.h"
#include "../common/instance/oscctrl_instance_fixup_pic32cxbz2.h"
#include "../common/instance/pac_instance_fixup_pic32cxbz2.h"
#include "../common/instance/pcc_instance_fixup_pic32cxbz2.h"
#include "../common/instance/pdec_instance_fixup_pic32cxbz2.h"
#include "../common/instance/port_instance_fixup_pic32cxbz2.h"
#include "../common/instance/qspi_instance_fixup_pic32cxbz2.h"
#include "../common/instance/ramecc_instance_fixup_pic32cxbz2.h"
#include "../common/instance/rstc_instance_fixup_pic32cxbz2.h"
#include "../common/instance/rtc_instance_fixup_pic32cxbz2.h"
#include "../common/instance/sdhc0_instance_fixup_pic32cxbz2.h"
#include "../common/instance/sdhc1_instance_fixup_pic32cxbz2.h"
#include "../common/instance/sercom0_instance_fixup_pic32cxbz2.h"
#include "../common/instance/sercom1_instance_fixup_pic32cxbz2.h"
#include "../common/instance/sercom2_instance_fixup_pic32cxbz2.h"
#include "../common/instance/sercom3_instance_fixup_pic32cxbz2.h"
#include "../common/instance/sercom4_instance_fixup_pic32cxbz2.h"
#include "../common/instance/sercom5_instance_fixup_pic32cxbz2.h"

#if   defined(__PIC32CX1025SG41100__) || defined(__PIC32CX1025SG41128__)
#include "../common/instance/sercom6_instance_fixup_pic32cxbz2.h"
#include "../common/instance/sercom7_instance_fixup_pic32cxbz2.h"
#endif

#include "../common/instance/supc_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tc0_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tc1_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tc2_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tc3_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tc4_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tc5_instance_fixup_pic32cxbz2.h"

#if   defined(__PIC32CX1025SG41100__) || defined(__PIC32CX1025SG41128__)
#include "../common/instance/tc6_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tc7_instance_fixup_pic32cxbz2.h"
#endif

#include "../common/instance/tcc0_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tcc1_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tcc2_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tcc3_instance_fixup_pic32cxbz2.h"
#include "../common/instance/tcc4_instance_fixup_pic32cxbz2.h"
#include "../common/instance/trng_instance_fixup_pic32cxbz2.h"
#include "../common/instance/usb_instance_fixup_pic32cxbz2.h"
#include "../common/instance/wdt_instance_fixup_pic32cxbz2.h"
