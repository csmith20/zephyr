...
#ifndef ZEPHYR_DRIVERS_ETHERNET_ETH_PIC32CXSG_GMAC_PRIV_H_
#define ZEPHYR_DRIVERS_ETHERNET_ETH_PIC32CXSG_GMAC_PRIV_H_

#include <zephyr/types.h>

#define MICROCHIP_OUI_B0 0x00
#define MICROCHIP_OUI_B1 0x04
#define MICROCHIP_OUI_B2 0x25
...
#define GMAC_ACTIVE_QUEUE_NUM           (CONFIG_ETH_PIC32CXSG_GMAC_QUEUES)
#define GMAC_ACTIVE_PRIORITY_QUEUE_NUM  (GMAC_ACTIVE_QUEUE_NUM - 1)

/** RX descriptors count for main queue */
#define MAIN_QUEUE_RX_DESC_COUNT        (CONFIG_ETH_PIC32CXSG_GMAC_BUF_RX_COUNT + 1)
...
#endif /* ZEPHYR_DRIVERS_ETHERNET_ETH_PIC32CXSG_GMAC_PRIV_H_ */
