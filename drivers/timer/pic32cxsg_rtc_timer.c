...
#define DT_DRV_COMPAT microchip_pic32cxsg_rtc

/**
 * @file
 * @brief Microchip PIC32CXSG series RTC-based system timer
 *
...
#ifdef MCLK
#define RTC_CLOCK_HW_CYCLES_PER_SEC SOC_PIC32CXSG_OSC32K_FREQ_HZ
#else
#define RTC_CLOCK_HW_CYCLES_PER_SEC SOC_PIC32CXSG_GCLK0_FREQ_HZ
#endif
